  ...
  return (
    ...
    items-center"
      >
        ...
        via-black/60 to-black/90 bg-clip-text 
        text-transparent"
              whileHover={{ y: -4 }}
              style={{
          ...
          bg-clip-text text-transparent"
            ...
            >
              Generate comprehensive and personalized exam-notes, project
              documentation, flow diagrams and revision-ready content with ease,
      ...
      grid grid-cols-1 md:grid-cols-4 gap-10'>
        ...
        <Feature icon="📊" title="Diagrams" des="Auto-generated visuals and diagrams for clarity."/>
