        ...
        <div onClick={() => navigate("/")} className="cursor-pointer">
         ...
         bg-clip-text text-transparent"
          ...
          <p className="text-sm text-gray-300 mt-1">
            AI-powered study companion for effortless exam preparation.
          </p>
        </div>
...
⬅️ Back
      ...
      <div className="mb-4 space-y-1">
        ...
        className=" text-start w-full px-3 py-2 rounded-lg text-sm text-gray-200 bg-white/10
        hover:bg-white/20">
         ➕ New Notes       
        ...
        <h2 className="mb-4 text-lg font-bold bg-gradient-to-r
        ...
        <ul className="space-y-3">
          {topics.map((t,i)=>(
            ...
            <div className="flex flex-wrap gap-2 mt-2 text-xs">
              {t.classLevel &&
              <span className="px-2 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300">ClassLevel : {t.classLevel}
              </span>}
               {t.examType &&
              <span className="px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-300">{t.examType}
              </span>}
