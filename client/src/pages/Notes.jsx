...
onClick={()=>navigate("/pricing")}
          ...
          <button 
          onClick={()=>navigate("/history")} className="px-4 py-3 rounded-full
          text-sm font-medium bg-white/10
          border border-white/20
          text-white
          hover:bg-white/20
          transition
      ...
      className="text-center text-black font-medium mb-6"
        >Generating exam-foucused notes...

        </motion.div>
      )}
      {error && (<div className="mb-6 text-center 
     ...
     {!result && <motion.div 
      ...
      justify-center bg-white/10 backdrop-blur-lg
      border border-dashed border-gray-300 text-gray-500
      shadow-inner">
        <span className="text-4xl mb-3">📘</span>
        <p className="text-sm">Generated notes will appear here
        </p>
...
rounded-2xl
bg-white
shadow-[0_15px_40px_rgba(0,0,0,0.1.5)]
p-6">
