...
transition={{ duration: 1.5}}
    ...
    flex items-center justify-between px-8 py-4'>
        <div className='flex items-center gap-3 '>
            ...
            text-white'>ExamNotes <span className='text-gray-400'>AI</span>
            </span>
        </div>
        <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                ...
                cursor-pointer'>
                    ...
                    <span>{credits}</span>
                    <motion.span className='ml-2 h-5 w-5 flex items-center justify-center 
                ...
                className='absolute 
                right-[-50px] mt-4 w-64 rounded-2xl
